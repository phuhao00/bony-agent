...
export function ProgrammerComposer({
  loading,
  onStreamText,
  onError,
  composerKey = 0,
  ...
  return (
    <AssistantComposer
      ...
      description={t("assistantPage.tools.programmer.composerDesc")}
      placeholder={t("assistantPage.tools.programmer.composerPlaceholder")}
