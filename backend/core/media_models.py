...
LOCAL_MODELS: Dict[str, List[Dict[str, Any]]] = {
    "image": [
        ...
        {
            "id": "seedance/gpt-image-2-text-to-image",
            "name": "SeaDance GPT-Image-2 文生图",
            "provider": "seedance",
            "model_id": "gpt-image-2-text-to-image",
            "api_type": "seedance_text2image",
            "description": "SeaDance 高质量文生图，支持 1:1/16:9/9:16 等比例",
        },
    ],
    "image_edit": [
        {
        ...
        {
            "id": "seedance/gpt-image-2-image-to-image",
            "name": "SeaDance GPT-Image-2 图生图/超分",
            "provider": "seedance",
            "model_id": "gpt-image-2-image-to-image",
            "api_type": "seedance_image_edit",
            "description": "高清超分、图像增强、图生图",
        },
    ],
    "video": [
        {
...
def get_current_media_model(modality: str) -> Dict[str, Any]:
    ...
    # image_edit 允许跨 Provider 选择（例如 LLM 用通义，但超分可以用 SeaDance）
    if modality == "image_edit":
