...
export function AdCampaignComposer({
  loading,
  onStreamText,
  onError,
  composerKey = 0,
  ...
  return (
    <AssistantComposer
      ...
      description={t("assistantPage.tools.adCampaign.composerDesc")}
      placeholder={t("assistantPage.tools.adCampaign.composerPlaceholder")}
